...
describe('truncate at end', function(){
        ...
        it("never differs from length by more than tolerance", function(){
            for(var t = 0; t < 30; t++){
                for(var i = 0; i <= s.length; i++){
                    assert(i - truncate.truncateEnd(s, i, {tolerance:t}).length <= t);
                }
            }
        });
    });
    ...
    describe('no breaks', function(){
        ...
        it("never exceeds length", function(){
            for(var t = 0; t < 30; t++){
                for(var i = 0; i < s.length+10; i++){
                    assert(truncate.truncateEnd(s, i, {tolerance:t}).length <= i);
                }
            }
        });
        it("never differs from length by more than tolerance", function(){
    ...
    describe("surrogate pairs", function(){
        ...
        it("doesn't break surrogate pairs", function(){
            for(var t = 0; t < 30; t++){
                for(var i = 0; i < 100; i++){
                    ...
                    var r = truncate.truncateEnd(s, i, {tolerance:t});
                    try{
        ...
        it("never differs from length by more than tolerance + 1", function(){
            for(var t = 0; t < 30; t++){
                for(var i = 0; i <= 100; i++){
                    assert(i - truncate.truncateEnd(s, i, {tolerance:t}).length <= t+1);
                }
            }
        });
    });
